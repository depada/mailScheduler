...
var TabScrollButton = React5.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_m_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime5.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime5.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var Tabs = React7.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime7.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime7.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime7.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime8.jsxs)(TabsRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime8.jsxs)(TabsScroller, {
...
//# sourceMappingURL=chunk-LBEGCIZX.js.map
